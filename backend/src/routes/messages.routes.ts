...
import { getUserConversations, startConversation, getConversation, sendMessage, updateMessages, getUnreadConversationsCount, readMessages, unreadMessagesExist, filterBarMessages } from "../controllers/messagesControllers.js";
...
router.get("/filter-messages/:conversationId", verify, filterBarMessages);
